...
def seed_accounts(): # this is the function that will seed the accounts for the database and the accounts table 
    amex = Account(account_name='American Express', account_type='Credit Card', account_balance=10000.00, userId=1)
    chase = Account(account_name='Chase', account_type='Checking', account_balance=20000.00, userId=1)
    wells = Account(account_name='Wells Fargo', account_type='Savings', account_balance=30000.00, userId=1)
